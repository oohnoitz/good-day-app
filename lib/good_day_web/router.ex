defmodule GoodDayWeb.Router do
  ...
  scope "/", GoodDayWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{GoodDayWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", GoodDayWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{GoodDayWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", GoodDayWeb do
    ...
    live_session :current_user,
      on_mount: [{GoodDayWeb.UserAuth, :mount_current_user}] do
